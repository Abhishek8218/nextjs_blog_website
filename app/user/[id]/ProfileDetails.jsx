  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      if (avatarToEdit) {
        ...
        console.log("Uploaded Image:", profileImg); 
      ...
      console.log("Update User Payload:", updateUser); 
      const response = await fetch(
        `https://infinity-insights.vercel.app/api/user/${params.id}`,
        {
          headers: {
